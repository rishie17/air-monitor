 ...
 * @param[out] device_handle Returned i2c_device_handle
...
/**
 * @brief Send the display wakeup command 0xAF to the display
 *
 * @param h Display handle
 * @return ESP_OK on success
 */
esp_err_t ssd1306_display_wakeup(ssd1306_handle_t h);

/**
 * @brief Send the display wakeup command 0xAE to the display
 *
 * @param h Display handle
 * @return ESP_OK on success
 */
esp_err_t ssd1306_display_sleep(ssd1306_handle_t h);
